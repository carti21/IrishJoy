...
<title>Landscape - IrishJoy.com</title>
...
<div id="head">
	...
	<?php // <div id="right_head_bar"> </div> ?>
 		...
 		<div id="footer"> 
 		<p>
 				<?php $page=$_GET['jump']; $page=$page-2; echo"<a href=\"http://irishjoy.com/tagged/landscape?jump=$page\" >"?> Prev Page</a> 
 				<?php echo"&nbsp; &nbsp; &nbsp;"?>
 				<?php $page=$_GET['jump']; $page=$page+2; echo"<a href=\"http://irishjoy.com/tagged/landscape?jump=$page\" >"?> Next Page</a> 
 				</p>		
